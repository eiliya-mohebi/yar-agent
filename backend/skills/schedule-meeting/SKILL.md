...
description: Schedule meetings, calls, or events on the calendar. Use when the user wants to book, plan, schedule, or set up a meeting or appointment with someone at a time. جلسه قرار ملاقات برنامه‌ریزی تقویم زمان‌بندی
---

## How to schedule well

1. Resolve relative dates ("next Tuesday", "tomorrow morning", «فردا صبح»,
   «۵ مرداد») into ISO 8601 using today's date from the system prompt.
   Morning = 09:00, afternoon = 14:00, evening = 18:00 unless the user says
   otherwise.
