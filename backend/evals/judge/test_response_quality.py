...
Yar actually used what it remembered, tone. Scores are 0–1 percentages
...
Requires OPENAI_API_KEY or YAR_API_KEY (AvalAI OpenAI-compatible endpoint).
"""
...
from evals.helpers import HAS_KEY, make_yar

pytestmark = pytest.mark.skipif(
    not HAS_KEY, reason="LLM-as-judge needs OPENAI_API_KEY or YAR_API_KEY"
)
